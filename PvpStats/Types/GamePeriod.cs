...
internal class GamePeriod {
    ...
    public static readonly List<GamePeriod> Season = new() {
        ...
        { new GamePeriod() {
            ...
            EndDate = new DateTime(2025,8,5,10,0,0,DateTimeKind.Utc),
        } },
        { new GamePeriod() {
            Name = "16",
            StartDate = new DateTime(2025,8,5,10,0,0,DateTimeKind.Utc),
            EndDate = new DateTime(2025,10,7,10,0,0,DateTimeKind.Utc),
        } },
        { new GamePeriod() {
            Name = "17",
            StartDate = new DateTime(2025,10,7,10,0,0,DateTimeKind.Utc),
            EndDate = new DateTime(2025,12,16,10,0,0,DateTimeKind.Utc),
        } },
        { new GamePeriod() {
            Name = "18",
            StartDate = new DateTime(2025,12,16,10,0,0,DateTimeKind.Utc),
            EndDate = new DateTime(2026,3,3,10,0,0,DateTimeKind.Utc),
        } },
        { new GamePeriod() {
            Name = "19",
            StartDate = new DateTime(2026,3,3,10,0,0,DateTimeKind.Utc),
            EndDate = new DateTime(2026,4,28,10,0,0,DateTimeKind.Utc),
        } },
        { new GamePeriod() {
            Name = "20",
    ...
    public static readonly List<GamePeriod> Patch = new() {
        ...
        { new GamePeriod() {
            Name = "7.3",
            StartDate = new DateTime(2025,8,5,10,0,0,DateTimeKind.Utc),
            EndDate = new DateTime(2025,9,2,10,0,0,DateTimeKind.Utc),
        } },
        { new GamePeriod() {
            Name = "7.31",
            StartDate = new DateTime(2025,9,2,10,0,0,DateTimeKind.Utc),
            EndDate = new DateTime(2025,10,7,10,0,0,DateTimeKind.Utc),
        } },
        { new GamePeriod() {
            Name = "7.35-7.38",
        ...
        { new GamePeriod() {
            Name = "7.4",
            StartDate = new DateTime(2025,12,16,10,0,0,DateTimeKind.Utc),
            EndDate = new DateTime(2026,1,27,10,0,0,DateTimeKind.Utc),
        } },
        { new GamePeriod() {
            Name = "7.41",
