...
internal class CrystallineConflictJobList : JobStatsList<CCPlayerJobStats, CrystallineConflictMatch> {
    ...
    protected override List<ColumnParams> Columns { get; set; } = new() {
        ...
        new NumericColumnParams{    Name = "Damage Dealt Per Min",                                                      Id = (uint)"ScoreboardPerMin.DamageDealt".GetHashCode(),            Width = 95f + Offset,                           Flags = ImGuiTableColumnFlags.WidthFixed },
        ...
        new NumericColumnParams{    Name = "Time on Crystal Per Min",                                                   Id = (uint)"ScoreboardPerMin.TimeOnCrystal".GetHashCode(),          Width = 100f + Offset,                          Flags = ImGuiTableColumnFlags.WidthFixed },
